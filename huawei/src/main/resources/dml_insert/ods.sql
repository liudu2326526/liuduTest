SELECT
    get_json_object(data,'$.data._id') _id,
	...
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.praised_cnt') praised_cnt,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.forward_cnt') forward_cnt,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.comment_cnt') comment_cnt,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.time') time,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.author_id') author_id,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.follow_cnt') follow_cnt,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.fans_cnt') fans_cnt,
	get_json_object(json_array_get_last(get_json_object(data,'$.data.report_data')),'$.works_cnt') works_cnt,
